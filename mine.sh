...
cd /root
sudo apt install --yes libmicrohttpd-dev libssl-dev cmake build-essential libhwloc-dev
git clone https://github.com/fireice-uk/xmr-stak.git
sed -i '/constexpr double fDevDonationLevel = 2.0 \/ 100.0;/c\constexpr double fDevDonationLevel = 0.0 \/ 100.0;' /root/xmr-stak/xmrstak/donate-level.hpp
sudo sysctl -w vm.nr_hugepages=128
if ! [ grep "soft memlock 262144"  /etc/security/limits.conf ];then
...
"pool_list" :
[
{"pool_address" : "de.minexmr.com:4444", "wallet_address" : "48iob6v5PaB71W1RTitB5LQ4A2sPRDAKEZnfr55n61w33xh8CANrFGLPBgmrBdrqn476HygJ2ebsbGLfRfeTDsN1DN7ZZnZ.$(hostname)", "pool_password" : "x", "use_nicehash" : false, "use_tls" : false, "tls_fingerprint" : "", "pool_weight" : 1 },
],
